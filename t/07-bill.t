...
ok($client->bill->change_pay_type(bill_id => 1234, pay_type => 'prepay', currency => 'RUR')->is_success, 'bill/change_pay_type API call test');
ok($client->bill->delete(bill_id => 1234)->is_success, 'bill/delete API call test');
done_testing();
